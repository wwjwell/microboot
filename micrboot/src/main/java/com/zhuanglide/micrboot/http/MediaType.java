...
/**
 * media type ,copy from spring mvc org.springframework.http.MediaType {@link MediaType}
 * Created by wwj on 2017/4/1.
 */
public class MediaType extends MimeType implements Serializable {
    private static final long serialVersionUID = 5466582442109651392L;
    ...
    public static MediaType parseMediaType(String mediaType) {
        ...
        try {
            ...
            throw new IllegalArgumentException(mediaType + "," +ex.getMessage());
        }
    }
