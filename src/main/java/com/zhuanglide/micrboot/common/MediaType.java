package com.zhuanglide.micrboot.common;
...
public class MediaType {
    ...
    public static Map<String, MediaType> BASE_MAP = new HashMap<String, MediaType>();
    ...
    static {
        BASE_MAP.put(WILDCARD, WILDCARD_TYPE);
        BASE_MAP.put(APPLICATION_XML, APPLICATION_XML_TYPE);
        BASE_MAP.put(APPLICATION_ATOM_XML, APPLICATION_ATOM_XML_TYPE);
        BASE_MAP.put(APPLICATION_XHTML_XML, APPLICATION_XHTML_XML_TYPE);
        BASE_MAP.put(APPLICATION_SVG_XML, APPLICATION_SVG_XML_TYPE);
        BASE_MAP.put(APPLICATION_JSON, APPLICATION_JSON_TYPE);
        BASE_MAP.put(APPLICATION_FORM_URLENCODED, APPLICATION_FORM_URLENCODED_TYPE);
        BASE_MAP.put(MULTIPART_FORM_DATA, MULTIPART_FORM_DATA_TYPE);
        BASE_MAP.put(APPLICATION_OCTET_STREAM, APPLICATION_OCTET_STREAM_TYPE);
        BASE_MAP.put(TEXT_PLAIN, TEXT_PLAIN_TYPE);
        BASE_MAP.put(TEXT_XML, TEXT_XML_TYPE);
        BASE_MAP.put(TEXT_HTML, TEXT_HTML_TYPE);
    }
    /**
